  ...
  <nav id="sidebar">
    ...
    <ul class="list-unstyled menu-categories" id="accordionExample">
      <li class="menu active">
        ...
        <ul class="collapse submenu recent-submenu mini-recent-submenu list-unstyled show" id="venue" data-parent="#accordionExample">
          <li>
            <a href="/venues">Venues</a>
          </li>
        </ul>
        <ul class="collapse submenu recent-submenu mini-recent-submenu list-unstyled show" id="bookings" data-parent="#accordionExample">
          <li>
